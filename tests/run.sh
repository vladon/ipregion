...
assert_eq "Yes" "$(gemini_web_availability_from_batch '[["wrb.fr","otAQ7b","[6,[false,null,false],true,null,null,null,false,null,null,null,null,null,false,false,1000,[]]"]]')" "gemini_web_availability_from_batch maps available"
assert_eq "Yes" "$(gemini_web_availability_from_batch '[["wrb.fr","otAQ7b","[6,[false,null,false],true,null,null,null,false,null,null,null,null,null,false,false,1016,[[\"id\",\"Flash\"]]]"]]')" "gemini_web_availability_from_batch maps unsigned with models"
assert_eq "No" "$(gemini_web_availability_from_batch '[["wrb.fr","otAQ7b","[6,[false,null,false],true,null,null,null,false,null,null,null,null,null,false,false,1016,[]]"]]')" "gemini_web_availability_from_batch maps unsigned without models"
assert_eq "No" "$(gemini_web_availability_from_batch '[["wrb.fr","otAQ7b","[6,[false,null,false],false,null,null,null,false,null,null,null,null,null,false,false,1060,[]]"]]')" "gemini_web_availability_from_batch maps location rejected"
assert_empty "$(gemini_web_availability_from_batch '')" "gemini_web_availability_from_batch handles empty input"
